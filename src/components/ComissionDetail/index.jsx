    ...
    return (
        <div className={styles.box} style={{backgroundColor:colorBgBase}}>
            ...
            <div className={styles.underBox} style={{backgroundColor:colorProductDetail}}>
                ...
                <div className={styles.noticeText}>數次要求未果且該單總額大於1000元新台幣時會走法律途徑。</div>
                <div className={styles.noticeText}>跑單：委託人在繪者交件後因自己沒能力付款或其他原因沒有付款就消失。</div>
                <div className={styles.noticeItem}>8. 非商業委託在未告知的前提下用於商業用途會公開黑單&要求加錢</div>
                <div className={styles.noticeText}>情節嚴重者會走法律途徑。</div>
                <div className={styles.noticeText}>商業行為：物品或服務的交換或所有權的轉移(與他人交換)、賺取利潤為目的或包含賺取利潤的行為。</div>
                ...
                <div className={styles.noticeText}>此修改為免費項目。</div>
                <div className={styles.noticeText}>最後一次交付的委託內容未提及但有作畫需求之項目會由我自行發揮。</div>
                <div className={styles.noticeText}>畫錯：指與最後一次交付的委託內容有所出入。</div>
